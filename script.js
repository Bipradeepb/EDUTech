...
buttonInvolved=document.querySelector(".get-involved");
buttonInvolvedi=document.querySelector(".get-involved .align-items i");

buttonInvolved.addEventListener("mouseover",()=>{
    buttonInvolvedi.classList.add("caret");
});

buttonInvolved.addEventListener("mouseout",()=>{
    buttonInvolvedi.classList.remove("caret");
})
